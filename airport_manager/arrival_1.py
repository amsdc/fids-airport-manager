...
STYLE = dict(
    header=dict(font=("Adani Regular", 40, "bold"), fg="#ffffff", bg="#666699"),
...
class DataFrame(tk.Frame,):
    def __init__(self, parent, con, data, style, *args, **kwargs):
        ...
        try:
            ...
            cur.execute("SELECT `sta`, `ifid`,`from`, `belt`, `eta`"
                        "FROM `flight` WHERE "
            ...
            # Table adding
            self.__heading_1 = tk.Label(self, text="STA", **self._style["header"])
            ...
            self.__heading_3 = tk.Label(self, text="From", **self._style["header"])
            self.__heading_3.grid(row=0, column=2, sticky=tk.N+tk.S+tk.E+tk.W)
            self.__heading_4 = tk.Label(self, text="Belt", **self._style["header"])
            self.__heading_4.grid(row=0, column=3, sticky=tk.N+tk.S+tk.E+tk.W)
            self.__heading_5 = tk.Label(self, text="ETA", **self._style["header"])
...
class HomeScreen(tk.Tk):
    def __init__(self, con, *args, **kwargs):
        ...
        self.__logout_btn = tk.Label(self, text="ARRIVAL", font=("Adani Regular", 60, "bold"), fg="#ffffff", bg="#666699")
        self.__logout_btn.grid(row=0, column=0, sticky=tk.E+tk.W)
        
        self._timelbl = tk.Label(self, text="...", font=("Adani Regular", 35, "bold"), fg="#ffffff", bg="#666699")
