...
STYLE = dict(
    header=dict(font=("Adani Regular", 40, "bold"), fg="#ffffff", bg="#800000"),
    body=dict(font=("Calibri", 35, "bold"), fg="#ffffff", bg="#000066"),
    err=dict(font=("Calibri", 60, "bold"), fg="#ffffff", bg="#000066")
)
...
class DataFrame(tk.Frame,):
    def __init__(self, parent, con, data, style, *args, **kwargs):
        ...
        try:
            ...
            self.__heading_9 = tk.Label(self, text="Check-in counter", **self._style["header"])
            ...
            for data in cur.fetchall():
                l1 = tk.Label(self, text=data[0], **self._style["body"])
                l1.grid(row=i, column=0, sticky=tk.N+tk.S+tk.E+tk.W)
                # print(self._data.get(data[1], data[1]), data[1])
                l2 = tk.Label(self, text=self._data.get(data[1], data[1]), **self._style["body"])
                l2.grid(row=i, column=1, sticky=tk.N+tk.S+tk.E+tk.W)

                l3 = tk.Label(self, text=data[2].strftime("%H:%M"), **self._style["body"])
                l3.grid(row=i, column=2, sticky=tk.N+tk.S+tk.E+tk.W)

                l4 = tk.Label(self, text=data[3].strftime("%H:%M"), **self._style["body"])
                ...
                l6 = tk.Label(self, text=data[5].title(), **self._style["body"])
...
class HomeScreen(tk.Tk):
    def __init__(self, con, *args, **kwargs):
        ...
        self.__logout_btn = tk.Label(self, text="DEPARTURES", font=("Adani Regular", 60, "bold"), fg="#ffffff", bg="#800000")
        self.__logout_btn.grid(row=0, column=0, sticky=tk.E+tk.W)
        
        self._timelbl = tk.Label(self, text="...", font=("Adani Regular", 35, "bold"), fg="#ffffff", bg="#800000")
