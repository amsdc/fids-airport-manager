...
STYLE = dict(
    ...
    header=dict(font=("Calibri", 35, "bold"), fg="#ffffff", bg="#666699"),
    body=dict(font=("Calibri", 30, "bold"), fg="#ffffff", bg="#000066"),
    body2=dict(font=("Calibri", 30, "bold"), fg="#ffffff", bg="#0066ff"),
...
class DataFrame(tk.Frame,):
    def __init__(self, parent, con, data, style, *args, **kwargs):
        ...
        try:
            ...
            cur.execute("SELECT `std`,`ofid`, `to`, `status`, `etd` "
                        "FROM `flight` WHERE "
            ...
            # Table adding
            self.__heading_1 = tk.Label(self, text="STD", **self._style["header"])
            ...
            self.__heading_4 = tk.Label(self, text="Status", **self._style["header"])
            self.__heading_4.grid(row=0, column=3, sticky=tk.N+tk.S+tk.E+tk.W)
            self.__heading_5 = tk.Label(self, text="ETD", **self._style["header"])
...
class HomeScreen(tk.Tk):
    def __init__(self, con, *args, **kwargs):
        ...
        self.__logout_btn = tk.Label(self, text="DOMESTIC DEPARTURES", **STYLE["title"])
