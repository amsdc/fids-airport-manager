...
class DataFrame(
    ...
    def __init__(self, parent, con, data, *args, **kwargs):
        ...
        try:
            ...
            self.__heading_2 = tk.Label(self, text="STD", **themes.get_label_attr(themes.get_style("header")))
            self.__heading_2.grid(row=0, column=2, **themes.get_grid_attr(themes.get_style("header")))
            self.__heading_3 = tk.Label(self, text="Flight No.", **themes.get_label_attr(themes.get_style("header")))
            self.__heading_3.grid(row=0, column=3, **themes.get_grid_attr(themes.get_style("header")))
            self.__heading_4 = tk.Label(self, text="Destination", **themes.get_label_attr(themes.get_style("header")))
            self.__heading_4.grid(row=0, column=4, **themes.get_grid_attr(themes.get_style("header")))
            self.__heading_5 = tk.Label(self, text="Status", **themes.get_label_attr(themes.get_style("header")))
            self.__heading_5.grid(row=0, column=5, **themes.get_grid_attr(themes.get_style("header")))
            self.__heading_6 = tk.Label(self, text="ETD", **themes.get_label_attr(themes.get_style("header")))
            self.__heading_6.grid(row=0, column=6, **themes.get_grid_attr(themes.get_style("header")))
            i = 1
            ...
            for data in cur.fetchall():
                ...
                l4 = tk.Label(self, text=self._data.get(data[2], data[2]), **themes.get_label_attr(style))
